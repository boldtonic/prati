...
Prati is a local AI command center for Web3 perpetual traders. It watches a filtered Bitunix mid/small-cap USDT perp universe every ~15 seconds, turns public market data into live breakout signals, and feeds that context into specialized Claude agents that give information about what building is, what is fading, what deserves a deeper look, and what to avoid.
